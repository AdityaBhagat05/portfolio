        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a href="https://www.linkedin.com/in/adityab12/" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 rounded-sm flex flex-col items-center justify-center gap-2 hover:border-emerald-500/30 transition-colors group">
